...
public abstract class BaseWebAboutUs<M extends BaseWebAboutUs<M>> extends Model<M> implements IBean {
	...
	public void setAu_id(java.lang.Integer au_id) {
		set("au_id", au_id);
	}

	public java.lang.Integer getAu_id() {
		return getInt("au_id");
	}

	public void setAu_code(java.lang.String au_code) {
		set("au_code", au_code);
	}

	public java.lang.String getAu_code() {
		return getStr("au_code");
	}
