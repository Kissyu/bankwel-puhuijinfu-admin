...
<div class="container-fluid">
    ...
    <div class="dreadcount">
        ...
        <span><i class="icon-list icon-red"></i>分配修改</span>
    </div>
    <!-- 面包屑导航  end -->
    <!-- 添加信息数据区 start -->
    <div class="row-fluid">
        <form id="mainForm" class="form-horizontal alert alert-info fade in span12" action="/phjfht/api/v1/policy/modifyAllocationPolicyPlate" method="POST">
            <!-- 提示信息标签 -->
            ...
            <fieldset>
                ...
                <div class="row">
                    <webTag:ProvincesSelectTag id="province_id" name="province_id" displayLable="省" value='${data.province_id}' onchange="provinceChange();" readonly="true" />
