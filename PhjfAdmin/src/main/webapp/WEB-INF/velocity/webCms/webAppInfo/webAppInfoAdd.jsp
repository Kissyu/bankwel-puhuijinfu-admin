...
<div class="container-fluid">
    ...
    <!-- 添加信息数据区 start -->
    <div class="row-fluid">
        <form id="mainForm" class="form-horizontal alert alert-info fade in span12" action="/phjfwebht/api/v1/webCms/addApp" method="POST">
            <!-- 提示信息标签 -->
            ...
            <fieldset>
                <div class="row">
                    ...
                    <webTag:DataDictionarySelectTag sys_id="Phjf" id="user_type" name="user_type" displayLable="设备类型" parentCode="sys_deviceType" value='${data.user_type}' isRequired="true"  />
                    <webTag:DataDictionarySelectTag sys_id="Phjf" id="app_type" name="app_type" displayLable="APP类型" parentCode="sys_appType" value='${data.app_type}' isRequired="true" />
                </div>
                <div class="row">
