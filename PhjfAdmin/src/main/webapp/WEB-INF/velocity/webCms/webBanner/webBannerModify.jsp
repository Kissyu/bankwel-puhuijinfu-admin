...
<div class="container-fluid">
    ...
    <!-- 添加信息数据区 start -->
    <div class="row-fluid">
        <form id="mainForm" class="form-horizontal alert alert-info fade in span12" action="/phjfwebht/api/v1/webCms/modifyBanner" method="POST">
            <!-- 提示信息标签 -->
            ...
            <fieldset>
                <div class="row">
                    ...
                    <webTag:Text id="banner_code" name="banner_code" displayLable="banner编号" value='${data.banner_code}' readonly="true"/>
