...
<div class="container-fluid" style="height: 650px; overflow-y: auto;">
    ...
    <!-- 添加信息数据区 start -->
    <div class="row-fluid">
        <form id="mainForm" class="form-horizontal alert alert-info fade in span12" action="/phjfht/api/v1/news/modifyNewsArticle" method="POST">
            <!-- 提示信息标签 -->
            ...
            <fieldset>
                ...
                <div class="row">
                    ...
                    <webTag:ImgUploadTag id="banner_logo" name="banner_logo" displayLable="轮播图" value="${data.banner_logo}" isShowImg="true"/>
                </div>
                <div class="row">
