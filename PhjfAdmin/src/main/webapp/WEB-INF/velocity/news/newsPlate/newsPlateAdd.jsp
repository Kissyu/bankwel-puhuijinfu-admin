...
<div class="container-fluid">
    ...
    <!-- 添加信息数据区 start -->
    <div class="row-fluid">
        <form id="mainForm" name="mainForm" class="form-horizontal alert alert-info fade in span12" action="/phjfht/api/v1/news/addNewsPlate" method="POST">
            <!-- 提示信息标签 -->
            ...
            <webTag:HiddenInputTag id="plate_id" name="plate_id" value="${data.plate_id}"/>
