        ...
        <form id="mainForm" class="form-horizontal alert alert-info fade in span12" action="/phjfht/api/v1/news/addNewsPlate" method="POST">
            ...
            <fieldset>
                <div class="row">
                    ...
                    <webTag:Text id="name" name="name" displayLable="版块名称" value='${data.name}' readonly="true" isRequired="true"/>
            ...
            <div class="row" align="right">
                <c:if test="${data.language == 'ZH_SIMP'}">
                    <a class="btn btn-danger" href="/phjfht/api/v1/news/goAddSimpNewsPlatePage"><i class="icon-inbox icon-white"></i>录入下一个</a>
                </c:if>
