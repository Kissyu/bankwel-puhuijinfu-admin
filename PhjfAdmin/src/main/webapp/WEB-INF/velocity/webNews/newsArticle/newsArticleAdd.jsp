...
//                onkeyup: false
            ...
            jQuery.validator.addMethod("getNewsPlate",function(value,element) {
                ...
                $("#plate_name").val(CommonPubAjax.isEmpty(newsPlate) ? "" : newsPlate.np_name);
                plate_code = value;
...
<div class="container-fluid" style="height: 650px; overflow-y: auto;">
    ...
    <div class="row-fluid">
        <form id="mainForm" class="form-horizontal alert alert-info fade in span12" action="/phjfwebht/api/v1/webNews/addNewsArticle" method="POST">
            ...
            <webTag:HiddenInputTag id="ni_id" name="ni_id" value="${data.ni_id}"/>
            <webTag:HiddenInputTag id="ni_code" name="ni_code" value="${data.ni_code}"/>
            ...
            <fieldset>
                <div class="row">
                    ...
                    <webTag:Text id="np_code" name="np_code" displayLable="版块编号" value='${data.np_code}' maxlength="32"/>
