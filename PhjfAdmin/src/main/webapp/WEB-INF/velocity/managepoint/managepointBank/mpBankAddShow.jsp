...
<div class="container-fluid">
    ...
    <!-- 添加信息数据区 start -->
    <div class="row-fluid">
        <form id="mainForm" class="form-horizontal alert alert-info fade in span12" action="/phjfht/api/v1/managepoint/addMpBankType" method="POST">
            <!-- 提示信息标签 -->
            ...
            <fieldset>
                ...
                <div class="row">
                    <webTag:DataDictionarySelectTag sys_id="Phjf" id="is_open_account" name="is_open_account" displayLable="是否可预约开户" parentCode="is_open_account" value='${data.is_open_account}' readonly="true" />
                    <webTag:Date id="start_date" name="start_date" displayLable="业务建立日期" value='${data.start_date}' readonly="true" />
                    <webTag:Date id="end_date" name="end_date" displayLable="业务终止日期" value='${data.end_date}' readonly="true" />
                </div>
                <div class="row">
            ...
            <div class="row" align="right">
                <a class="btn btn-danger" href="/phjfht/api/v1/managepoint/goAddMpBankTypePage"><i class="icon-inbox icon-white"></i>录入下一个</a>
