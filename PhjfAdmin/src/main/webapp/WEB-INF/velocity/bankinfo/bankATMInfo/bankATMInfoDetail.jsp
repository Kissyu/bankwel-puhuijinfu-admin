...
<div class="container-fluid" style="height: 650px; overflow-y: auto;">
    ...
    <!-- 添加信息数据区 start -->
    <div class="row-fluid">
        <form id="mainForm" class="form-horizontal alert alert-info fade in span12" action="/phjfht/api/v1/managepoint/modifyManagepoint" method="POST">
            <!-- 提示信息标签 -->
            ...
            <fieldset>
                <div class="row">
                    <webTag:Text id="bt_code" name="bt_code" displayLable="银行类型代码" value='${data.bt_code}' readonly="true" />
                    <webTag:Text id="bt_name" name="bt_name" displayLable="银行类型名称" value='${data.bt_name}' readonly="true" />
                    <webTag:Text id="third_atm_code" name="third_atm_code" displayLable="ATM第三方编码" value='${data.third_atm_code}' readonly="true" />
                </div>
                <div class="row">
                    <webTag:Text id="bank_code" name="bank_code" displayLable="银行编码" value='${data.bank_code}' readonly="true" />
                    <webTag:Text id="bank_name" name="bank_name" displayLable="银行名称" value='${data.bank_name}' readonly="true" />
                    <webTag:Text id="name" name="name" displayLable="ATM名称" value='${data.name}' readonly="true" />
                </div>
                <div class="row">
                    <webTag:Text id="contact" name="contact" displayLable="联系人姓名" value='${data.contact}' readonly="true" />
