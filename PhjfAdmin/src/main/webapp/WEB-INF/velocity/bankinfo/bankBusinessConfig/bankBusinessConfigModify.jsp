    ...
    <div class="row-fluid">
        <form id="mainForm" class="form-horizontal alert alert-info fade in span12" action="/phjfht/api/v1/bankinfo/modifyBankBusinessConfig" method="POST">
            ...
            <fieldset>
                ...
                <div class="row">
                    <webTag:Text id="app_version" name="app_version" displayLable="APP版本号" value='${data.app_version}' isRequired="true" maxlength="32"/>
                ...
                <div class="row">
                    <webTag:TextareaTag id="value" name="value" displayLable="配置信息：" textClass="input-xxlarge" rows="20" value='${data.value}'  />
                </div>
            </fieldset>
