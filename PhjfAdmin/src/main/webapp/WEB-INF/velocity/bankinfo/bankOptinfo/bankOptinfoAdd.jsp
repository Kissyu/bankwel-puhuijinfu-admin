...
<div class="container-fluid">
    ...
    <div class="row-fluid">
        <form id="mainForm" class="form-horizontal alert alert-info fade in span12" action="/phjfht/api/v1/bankinfo/addBankOptinfo" method="POST">
            ...
            <fieldset>
                <div class="row">
                    <webTag:Text id="bank_code" name="bank_code" displayLable="银行机构编号" value='${data.bank_code}' isRequired="true" maxlength="32" />
                ...
                <div class="row">
                    ...
                    <webTag:Text id="mobilephone" name="mobilephone" displayLable="移动电话" value='${data.mobilephone}' maxlength="11" isMobile="true" isRequired="true"/>
