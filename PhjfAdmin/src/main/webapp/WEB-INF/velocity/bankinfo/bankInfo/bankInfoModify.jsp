...
<div class="container-fluid" style="height: 650px; overflow-y: auto;">
    ...
    <!-- 添加信息数据区 start -->
    <div class="row-fluid">
        <form id="mainForm" class="form-horizontal alert alert-info fade in span12" action="/phjfht/api/v1/bankinfo/modifyBankInfo" method="POST">
            <!-- 提示信息标签 -->
            ...
            <fieldset>
                ...
                <div class="row">
                    ...
                    <webTag:Text id="contact" name="contact" displayLable="联系人" value='${data.contact}' isRequired="true" maxlength="32" />
                </div>
                <div class="row">
