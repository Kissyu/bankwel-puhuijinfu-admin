...
<div class="container-fluid" style="height: 650px; overflow-y: auto;">
    ...
    <!-- 添加信息数据区 start -->
    <div class="row-fluid">
        <form id="mainForm" class="form-horizontal alert alert-info fade in span12" action="/phjfwebht/api/v1/partner/modifyPartner" method="POST">
            <!-- 提示信息标签 -->
            ...
            <webTag:HiddenInputTag id="nav_id" name="nav_id" value="${data.partner_id}"/>
            <webTag:HiddenInputTag id="nav_code" name="nav_code" value="${data.partner_code}"/>
            ...
            <fieldset>
                <div class="row">
                    ...
                    <webTag:Text id="partner_name" name="partner_name" displayLable="合作伙伴名称" value='${data.partner_name}' isRequired="true" maxlength="100" />
                    <webTag:ImgUploadTag id="picture" name="picture" displayLable="图片" value="${data.picture}" isRequired="true" />
                </div>
                <div class="row">
