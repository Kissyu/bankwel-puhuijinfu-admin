...
<head>
    ...
    <script>
        $(function(){
            if($('#amTime_format').val()=="yyyy-MM-dd HH:mm:ss") {
                $('#format2,#format3').hide();
                $('#format1').show();
            ...
            }else if($('#amTime_format').val()=="yyyy-MM-dd") {
                $('#format1,#format3').hide();
                $('#format2').show();
                $('#start_time1,#end_time1,#start_time2,#end_time2,#start_time3,#end_time3').attr("isRequired","false");
...
<div class="container-fluid" style="height: 650px; overflow-y: auto;">
    ...
    <div class="dreadcount">
        ...
        <span><i class="icon-list icon-red"></i>x修改</span>
    </div>
    <!-- 面包屑导航  end -->
    <!-- 添加信息数据区 start -->
    <div class="row-fluid">
        <form id="mainForm" class="form-horizontal alert alert-info fade in span12" action="/phjfht/api/v1/appointmentTime/modifyBankAmTime" method="POST">
            <!-- 提示信息标签 -->
            ...
            <fieldset>
                <div class="row">
                    <webTag:Text id="bt_code" name="institution_code" displayLable="银行类型代码" value='${data.bt_code}' readonly="true" isRequired="true" maxlength="32"/>
