...
jQuery.validator.addMethod("mobile",function(value,element){
	return this.optional(element) || /^((17[0-9])|(13[0-9])|(15[0-9])|(18[0-9]))\d{8}$/.test(value);
},"请输入正确的移动电话");
...
jQuery.validator.addMethod("phone",function(value,element){
	return this.optional(element) || /^(\d{3,4}-)?\d{6,8}(-\d{3,5})?$/.test(value) || /^((17[0-9])|(13[0-9])|(15[0-9])|(18[0-9]))\d{8}$/.test(value) ;
},"请输入正确的电话号码");

jQuery.validator.addMethod("decimal", function(value, element) {
	return this.optional(element) || /^\d{1,9}([\.]\d{1,2})?$/.test(value);
}, "请输入0~99999999.99內的数值");
...
jQuery.validator.addMethod("mobilePhone",function(value,element){
	return this.optional(element) || /^(13|15|18|17)\d{9}$/.test(value);
},"请输入正确的手机号码");

//验证电话号码和手机号
jQuery.validator.addMethod("mobileAndPhone",function(value,element){
	return (this.optional(element) || /^(\d{8}|\d{7})$/.test(value)) || /^(13|15|18|17)\d{9}$/.test(value);
},"请输入正确的手机号或电话号码");
jQuery.validator.addMethod("mobileAndTelephone",function(value,element){
	return (this.optional(element) || /^(\d{8}|\d{7})$/.test(value)) || /^(13|15|18|17)\d{9}$/.test(value) || /^(\d{3,4}-)?\d{6,8}(-\d{3,5})?$/.test(value);
},"请输入正确的手机号或电话号码");
...
//校验格式为999999.9999的数值,最大值为999999999999.9999
jQuery.validator.addMethod("checkNumFormat_4", function(value, element) {
	return this.optional(element) || /^\d{1,12}([\.]\d{1,4})?$/.test(value);
}, "请输入格式如9999.9999的数值，小数点后保留4位。");

//校验最大值为999999999999.9999,小数点后最多保留4位
jQuery.validator.addMethod("checkNumMaxFormat_4", function(value, element) {
	return this.optional(element) || /^\d{1,12}([\.]\d{1,4})?$/.test(value);
}, "请输入0~999999999999.9999內的数值");

//校验最大值为999999999999.9999,小数点后最多保留4位
jQuery.validator.addMethod("checkNumMaxFormat_2", function(value, element) {
...
}, $.validator.format("请输入正确的包名格式，如：com.haokai.dictionary"));
...
jQuery.validator.addMethod("checkPolicyMeny", function(value, element) {
	return this.optional(element) || /^\d{1,10}([\.]\d{1,4})?$/.test(value);
}, "金额不超过9999999999.9999。");

//double型数值，最大不超过9999999999.9999
jQuery.validator.addMethod("checkDouble14", function(value, element) {
	return this.optional(element) || /^\d{1,10}([\.]\d{1,4})?$/.test(value);
}, "请输入正确的数值，最大值为9999999999.9999。");
...
jQuery.validator.addMethod("checkAge", function(value, element) {
	return this.optional(element) || /^(?:[0-9][0-9]?|1[01][0-9]|120)$/.test(value);
}, "请输入正确的年龄");
...
jQuery.validator.addMethod("checkFeeRate", function(value, element) {
	return this.optional(element) || /^(([0-9])\.([0-9]){1,4}|([0-9]))$/.test(value);
}, "请输入正确的手续费比率，最大值为9.9999");
...
function isLong(obj){
	var str = $(obj).val();
	if(str == '2'){
		$("#certi_validDate").val("2099-09-09");
		$("#certi_validDate").attr("disabled","disabled");
		$("label[for='certi_validDate'][class='error']").remove();
	    $('#certi_validDate').attr("class","input-medium required");
	}else{
		$("#certi_validDate").removeAttr("disabled");
	}
}
