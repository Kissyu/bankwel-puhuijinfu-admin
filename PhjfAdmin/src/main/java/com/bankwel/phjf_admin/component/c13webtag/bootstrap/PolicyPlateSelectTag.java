...
import com.bankwel.phjf_admin.common.model.core.PolicyPlate;
import com.bankwel.phjf_admin.component.c11assistant.TransHelper;

import java.util.List;

/**
 * @ClassName: PolicyPlateSelectTag
 * @Description: 政策板块标签
 * @author: DukeMr.Chen
 ...
 *
 */
public class PolicyPlateSelectTag  extends SelectTag {
    ...
    public String printSelect(){
        ...
        List<IDynamicSelectData> selectDataList= PolicyPlate.dao.querySelectData(this.language);
