...
public abstract class BasePolicyArticle<M extends BasePolicyArticle<M>> extends Model<M> implements IBean {
	...
	public void setPa_id(java.lang.Integer pa_id) {
		set("pa_id", pa_id);
	}

	public java.lang.Integer getPa_id() {
		return getInt("pa_id");
	}
