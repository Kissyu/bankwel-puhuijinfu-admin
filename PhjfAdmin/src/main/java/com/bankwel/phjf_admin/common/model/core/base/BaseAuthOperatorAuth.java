...
public abstract class BaseAuthOperatorAuth<M extends BaseAuthOperatorAuth<M>> extends Model<M> implements IBean {
	...
	public void setOperator_seq_id(java.lang.Integer operator_seq_id) {
		set("operator_seq_id", operator_seq_id);
	}

	public java.lang.Integer getOperator_seq_id() {
		return getInt("operator_seq_id");
	}
