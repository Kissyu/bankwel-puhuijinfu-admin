...
<div class="container-fluid" style="height: 650px; overflow-y: auto;">
    ...
    <!-- 添加信息数据区 start -->
    <div class="row-fluid">
        <form id="mainForm" class="form-horizontal alert alert-info fade in span12" action="/phjfht/api/v1/nav/addNav" method="POST">
            <!-- 提示信息标签 -->
            ...
            <fieldset>
                <div class="row">
                    ...
                    <webTag:Text id="nav_name" name="nav_name" displayLable="导航名称" value='${data.nav_name}' isRequired="true"  readonly="true"  maxlength="100" />
                </div>
                <div class="row">
