        ...
        <form id="mainForm" class="form-horizontal alert alert-info fade in span12" action="/phjfht/api/v1/news/addNewsArticle" method="POST">
            ...
            <fieldset>
                ...
                <div class="row">
                    ...
                    <webTag:Text id="source_url" name="source_url" displayLable="来源链接地址" value='${data.source_url}' maxlength="255" readonly="true"/>
                </div>
                <div class="row">
                ...
                <div class="row">
                    <webTag:DataDictionarySelectTag sys_id="Phjf" id="is_banner" name="is_banner" displayLable="是否轮播" parentCode="is_banner" value='${data.is_banner}' readonly="true" />
            ...
            <div class="row" align="right">
                <c:if test="${data.language == 'ZH_SIMP'}">
                    <a class="btn btn-danger" href="/phjfht/api/v1/news/goAddSimpNewsArticlePage"><i class="icon-inbox icon-white"></i>录入下一个</a>
                </c:if>
