...
<div class="container-fluid">
    ...
    <!-- 添加信息数据区 start -->
    <div class="row-fluid">
        <form id="mainForm" name="mainForm" class="form-horizontal alert alert-info fade in span12" action="/phjfwebht/api/v1/webNews/addNewsPlate" method="POST">
            <!-- 提示信息标签 -->
            ...
            <webTag:HiddenInputTag id="np_id" name="np_id" value="${data.np_id}"/>
            <webTag:HiddenInputTag id="np_code" name="np_code" value="${data.np_code}"/>
            ...
            <fieldset>
                <div class="row">
                    ...
                    <webTag:Text id="np_name" name="np_name" displayLable="版块名称" value='${data.np_name}' isRequired="true" maxlength="100" />
            ...
            <div class="row" align="right">
                <button id="submitBtn" type="submit" class="btn btn-danger"><i class="icon-inbox icon-white" onload=""></i>保存并查看</button>
