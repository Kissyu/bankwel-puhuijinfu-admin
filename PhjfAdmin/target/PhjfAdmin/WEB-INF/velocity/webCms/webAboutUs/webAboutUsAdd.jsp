...
<head>
    ...
    <script>
        $(function(){
            ...
            //关于我们导航信息自动带出
            jQuery.validator.addMethod("getAboutUsNav",function(value,element) {
                var aboutUsNavFlag = true;
                if (nav_code == value) {
                    return aboutUsNavFlag;
                }
                var aboutUsNav = CommonPubAjax.getAboutUsNav(value);

                $("#nav_name").val(CommonPubAjax.isEmpty(aboutUsNav) ? "" : aboutUsNav.nav_name);
                nav_code = value;
                aboutUsNavFlag = CommonPubAjax.isEmpty(aboutUsNav) ? false : true;
                return aboutUsNavFlag;
            },"导航编号不存在，请重新录入。");
...
<div class="container-fluid">
    ...
    <!-- 添加信息数据区 start -->
    <div class="row-fluid">
        <form id="mainForm" class="form-horizontal alert alert-info fade in span12" action="/phjfwebht/api/v1/webCms/addAboutUs" method="POST">
            <!-- 提示信息标签 -->
            ...
            <fieldset>
                <div class="row">
                    ...
                    <webTag:Text id="nav_code" name="nav_code" displayLable="所属导航编号" value='${data.nav_code}' maxlength="255" isRequired="true" />
