...
<div class="container-fluid" style="height: 650px; overflow-y: auto;">
    ...
    <!-- 添加信息数据区 start -->
    <div class="row-fluid">
        <form id="mainForm" class="form-horizontal alert alert-info fade in span12" action="/phjfht/api/v1/bankinfo/addLoanInfo" method="POST">
            <!-- 提示信息标签 -->
            ...
            <fieldset>
                ...
                <div class="row">
                    <webTag:DataDictionarySelectTag sys_id="Phjf" id="status" name="status" displayLable="状态" parentCode="loan_status" value='${data.status}' defaultValue="2" isRequired="true" />
                ...
                <div class="row">
                    <webTag:TextareaTag id="apply_condition" name="apply_condition" rows="16" displayLable="申请条件:" value="${data.apply_condition}"/>
                </div>
                <div class="row">
