        ...
        <form id="mainForm" class="form-horizontal alert alert-info fade in span12" action="/phjfht/api/v1/newsManage/addNewsPlate" method="POST">
            ...
            <fieldset>
                <div class="row">
                    ...
                    <webTag:BankTypeSelectTag id="bt_code" name="bt_code" displayLable="银行类型" value='${data.bt_code}' isRequired="true" readonly="true"/>
                    <webTag:DataDictionarySelectTag sys_id="Phjf" id="loan_plate" name="loan_plate" displayLable="所属版块" parentCode="loan_plate" value='${data.loan_plate}' isRequired="true" readonly="true" />
                </div>
                <div class="row">
                    <webTag:DataDictionarySelectTag sys_id="Phjf" id="loan_use_type" name="loan_use_type" displayLable="用途" parentCode="loan_useType" value='${data.loan_use_type}' readonly="true" isRequired="true" />
                    <webTag:Text id="name" name="name" displayLable="产品名称" value='${data.name}' isRequired="true" readonly="true"/>
            ...
            <div class="row" align="right">
                <a class="btn btn-danger" href="/phjfht/api/v1/bankinfo/goAddLoanInfoPage"><i class="icon-inbox icon-white"></i>录入下一个</a>
