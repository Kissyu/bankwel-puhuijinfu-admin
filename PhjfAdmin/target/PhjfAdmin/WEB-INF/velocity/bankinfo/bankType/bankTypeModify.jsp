...
<div class="container-fluid" style="height: 650px; overflow-y: auto;">
    ...
    <!-- 添加信息数据区 start -->
    <div class="row-fluid">
        <form id="mainForm" class="form-horizontal alert alert-info fade in span12" action="/phjfht/api/v1/bankinfo/modifyBankType" method="POST">
            <!-- 提示信息标签 -->
            ...
            <fieldset>
                <div class="row">
                    <webTag:Text id="bt_code" name="bt_code" displayLable="银行编号" value='${data.bt_code}' readonly="true" maxlength="32"/>
                ...
                <div class="row">
                    <webTag:ImgUploadTag id="bt_logo" name="bt_logo" displayLable="LOGO图片" value="${data.bt_logo}" isShowImg="true" isRequired="true" />
                    <webTag:ImgUploadTag id="bt_card_bgimg" name="bt_card_bgimg" displayLable="二类户银行卡背景图片" value="${data.bt_card_bgimg}" isShowImg="true" />
                    <webTag:ImgUploadTag id="bt_card_img" name="bt_card_img" displayLable="二类户银行卡开户图片" value="${data.bt_card_img}" isShowImg="true" />
                </div>
                <div class="row">
