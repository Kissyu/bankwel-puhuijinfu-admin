...
<div class="container-fluid" style="height: 650px; overflow-y: auto;">
    ...
    <!-- 添加信息数据区 start -->
    <div class="row-fluid">
        <form id="mainForm" class="form-horizontal alert alert-info fade in span12" action="/phjfht/api/v1/bankinfo/addBankBusinessConfig" method="POST">
            <!-- 提示信息标签 -->
            ...
            <fieldset>
                <div class="row">
                    ...
                    <webTag:DataDictionarySelectTag sys_id="Phjf" id="business_code" name="business_code" displayLable="银行业务" parentCode="bank_function" value='${data.business_code}'  readonly="true"/>
                </div>
                <div class="row">
                ...
                <div class="row">
                    <webTag:TextareaTag id="value" name="value" displayLable="配置信息" rows="20" value='${data.value}'  readonly="true" textClass="input-xxlarge"/>
                </div>
            </fieldset>
            <div class="row" align="right">
                    <a class="btn btn-danger" href="/phjfht/api/v1/bankinfo/goAddSimpBankBusinessConfigPage"><i class="icon-inbox icon-white"></i>录入下一个</a>
