        ...
        <form id="mainForm" class="form-horizontal alert alert-info fade in span12" >
            ...
            <fieldset>
                <div class="row">
                    ...
                    <webTag:Text id="bt_code" name="bt_code" displayLable="银行类型编号" value='${data.bt_code}' maxlength="32" readonly="true"/>
                    <webTag:Text id="bt_name" name="bt_name" displayLable="银行类型名称" value='${data.bt_name}' readonly="true" maxlength="32"/>
                </div>
                <div class="row">
                    <webTag:Text id="name" name="name" displayLable="银行机构名称" value='${data.name}' readonly="true"/>
                ...
                <div class="row">
                    <webTag:Text id="third_bank_code" name="third_bank_code" displayLable="银行网点第三方编码" value='${data.third_bank_code}' maxlength="32" readonly="true"/>
