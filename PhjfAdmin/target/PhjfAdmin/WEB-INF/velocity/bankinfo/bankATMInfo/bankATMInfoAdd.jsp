    ...
    <script>
        ...
        $(function(){
            ...
            jQuery.validator.addMethod("getBank",function(value,element) {
                ...
                $(element).data('error-msg','银行代码不存在，请重新录入。');
                return bankFlag;
...
<div class="container-fluid" style="height: 650px; overflow-y: auto;">
    ...
    <div class="row-fluid">
        <form id="mainForm" class="form-horizontal alert alert-info fade in span12" action="/phjfht/api/v1/bankinfo/addBankATM" method="POST">
            ...
            <webTag:HiddenInputTag id="bank_atm_id" name="bank_atm_id" value="${data.mp_id}"/>
            <webTag:HiddenInputTag id="atm_code" name="atm_code" value="${data.mp_code}"/>
            ...
            <fieldset>
                ...
                <div class="row">
                    ...
                    <webTag:Text id="bank_name" name="bank_name" displayLable="银行机构名称" value='${data.bank_name}' readonly="true" maxlength="32" />
