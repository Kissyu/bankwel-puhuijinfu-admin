...
<div class="container-fluid">
    ...
    <!-- 添加信息数据区 start -->
    <div class="row-fluid">
        <form id="mainForm" class="form-horizontal alert alert-info fade in span12" action="/phjfht/api/v1/policy/addPolicyPlate" method="POST">
            <!-- 提示信息标签 -->
            ...
            <fieldset>
                ...
                <div class="row">
                    <webTag:ImgUploadTag id="logo" name="logo" displayLable="图片" value="${data.logo}" isRequired="true" isShowImg="true" readonly="true"/>
            ...
            <div class="row" align="right">
                <c:if test="${data.language == 'ZH_SIMP'}">
                    <a class="btn btn-danger" href="/phjfht/api/v1/policy/goAddSimpPolicyPlatePage"><i class="icon-inbox icon-white"></i>录入下一个</a>
                </c:if>
